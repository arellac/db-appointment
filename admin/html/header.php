<header class="flex items-center justify-between px-6 py-4 bg-white border-b-4 border-indigo-600">
    ...
    <div class="flex items-center">
        <div x-data="{ notificationOpen: false }" class="relative">
            ...
            <div x-cloak x-show="notificationOpen" class="hidden absolute right-0 z-10 mt-2 overflow-hidden bg-white rounded-lg shadow-xl w-80" style="width:20rem;">
        ...
        <div x-data="{ dropdownOpen: false }"  class="relative">
            ...
            <div x-cloak x-show="dropdownOpen" class="hidden absolute right-0 z-10 w-48 mt-2 overflow-hidden bg-white rounded-md shadow-xl">
